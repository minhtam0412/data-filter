...
@Component({
  ...
  template: `
      <div #autoCompleteContainer class="ngui-auto-complete">
          ...
          <ul *ngIf="dropdownVisible" [class.empty]="emptyList" [class]="dropdowncustomclass">
...
export class NguiAutoCompleteComponent implements OnInit {
  ...
  @Input('dropdown-custom-class') public dropdowncustomclass = ''; // custom style cho dropdown
  ...
  @ViewChild('autoCompleteContainer', {static: false}) public autoCompleteContainer: ElementRef;
