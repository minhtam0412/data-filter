...
import {PricecalculatorService} from '../../../calculator/pricecalculator/pricecalculator.service';
...
export class ProductlistComponent implements OnInit, AfterViewInit {
  ...
  lstDataResult: ProductDetail[] = []; // danh sách CustomerType
  ...
  constructor(private modalService: NgbModal, private service: ProductService, private authenService: AuthenService,
              private notificationService: NotificationService, private pricecalculatorService: PricecalculatorService) {
  }
  ...
  // mở các dialog
  openDialog(rowData?: ProductDetail) {
    if (rowData !== undefined) {
      if (!this.authenService.isHasPermission('productlist', 'EDIT')) {
    ...
    modalRef.componentInstance.lstCustomer = this.lstCustomer;
    if (rowData === undefined) {
