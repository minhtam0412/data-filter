...
export class AggregatecostsService {
  ...
  getData(searchString?: string, startRow?: number, maxRow?: number) {
    ...
    return this.httpClient.post<ResponeResult>( this.baseURL +  'api/list/aggregatecosts', jsonString, { headers });
  }

  Insert(obj: AggregateCosts, isNew: boolean) {
    ...
    return this.httpClient.post<ResponeResult>(this.baseURL + 'api/list/saveaggregatecosts', jsonString, { headers });
  }
  ...
  Delete(Id: any) {
    ...
    return this.httpClient.post<ResponeResult>(this.baseURL + 'api/list/deleteaggregatecosts', jsonString, { headers });
  }
  ...
  Sort(UpID: number, DowID: number) {
    ...
    return this.httpClient.post<ResponeResult>(this.baseURL + 'api/list/updateSortOrderAggregateCosts', jsonString, { headers });
  }
}
