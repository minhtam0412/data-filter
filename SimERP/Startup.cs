...
namespace SimERP
{
    public class Startup
    {
        ...
        {
            var arrAllowCORSURL = System.Configuration.ConfigurationManager.AppSettings["AllowCORSURL"];
            var AllowCORSURL = arrAllowCORSURL.Split(',');
            var corsBuilder = new CorsPolicyBuilder();
            corsBuilder.AllowCredentials();
            corsBuilder.AllowAnyHeader();
            corsBuilder.AllowAnyMethod();
            corsBuilder.WithOrigins(AllowCORSURL);
            corsBuilder.AllowCredentials();
